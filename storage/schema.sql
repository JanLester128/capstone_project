...
CREATE TABLE `class_details` (
  ...
  `enrollment_status` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'enrolled',
  `section_id` bigint unsigned NOT NULL,
...
CREATE TABLE `enrollments` (
  ...
  `student_lrn` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `grade_level` enum('Grade 11','Grade 12') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `enrollment_method` enum('self','auto','manual') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'self',
  `cor_generated` tinyint(1) NOT NULL DEFAULT '0',
  `cor_generated_at` timestamp NULL DEFAULT NULL,
  `cor_subjects` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `summer_class_schedules` (
  ...
  `class_days` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `start_time` time NOT NULL,
  `end_time` time NOT NULL,
...
CREATE TABLE `transferee_previous_schools` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `student_id` bigint unsigned NOT NULL,
  `last_school` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (370,'2025_10_13_111100_add_shs_grade_logic_to_enrollments',6);
