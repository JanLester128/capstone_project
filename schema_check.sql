...
CREATE TABLE `class_details` (
  ...
  `enrolled_at` timestamp NOT NULL DEFAULT '2025-09-30 22:49:44',
  PRIMARY KEY (`id`),
...
CREATE TABLE `student_personal_info` (
  ...
  `student_status` enum('New Student','Continuing','Transferee') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'New Student' COMMENT 'Student enrollment status: New Student, Continuing, or Transferee',
  `school_year` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lrn` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `ip_community` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `four_ps` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pwd_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_grade` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_sy` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `last_school` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `psa_birth_certificate` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `report_card` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (280,'2025_01_20_220800_add_student_status_to_student_personal_info_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (281,'2025_01_20_230000_fix_student_personal_info_table_schema',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (282,'2025_01_20_230001_fix_student_personal_info_table_schema_v2',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (283,'2025_01_20_235000_remove_special_needs_column',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (284,'2025_01_27_033200_rename_enrolled_grade_level_to_intended_grade_level',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (285,'2025_09_04_141928_add_start_end_dates_to_school_years_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (286,'2025_09_09_154500_add_school_year_id_to_class_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (287,'2025_09_09_154600_add_duration_to_class_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (288,'2025_09_10_081303_create_sessions_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (289,'2025_09_11_174600_add_description_to_strands_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (290,'2025_09_14_213500_update_varchar_columns_to_100',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (291,'2025_09_16_000000_add_is_coordinator_to_users_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (292,'2025_09_17_015132_add_strand_choices_to_enrollments_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (293,'2025_09_17_015211_align_enrollments_table_to_normalized_schema',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (294,'2025_09_17_021126_add_strand_choices_to_enrollments_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (295,'2025_09_17_083224_add_psa_birth_certificate_to_student_personal_info_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (296,'2025_09_18_050117_normalize_enrollments_status_to_varchar',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (297,'2025_09_18_123500_remove_enrollment_status_from_student_personal_info',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (298,'2025_09_20_140000_add_school_year_id_to_sections_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (299,'2025_09_22_071200_add_year_start_end_to_school_years_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (300,'2025_09_22_084000_fix_school_years_unique_constraint',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (301,'2025_09_22_092400_ensure_student_status_column_exists',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (302,'2025_09_22_093300_add_guardian_fields_to_student_personal_info',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (303,'2025_09_22_123100_add_section_id_to_student_personal_info',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (304,'2025_09_22_132500_add_unique_constraint_to_enrollments',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (305,'2025_09_22_152400_remove_student_fields_from_class_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (306,'2025_09_23_095400_ensure_school_years_schema_consistency',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (307,'2025_09_25_105700_remove_unused_columns_from_enrollments',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (308,'2025_09_25_114500_update_school_year_for_philippine_shs',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (309,'2025_09_26_064800_add_assigned_section_id_to_enrollments_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (310,'2025_09_26_074500_add_last_login_at_to_users_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (311,'2025_09_27_141408_update_grades_table_for_philippine_shs_quarterly_system',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (312,'2025_09_28_155204_remove_final_grade_from_grades_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (313,'2025_09_28_155715_update_grades_student_id_to_reference_users_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (314,'2025_09_28_161417_add_approval_system_to_grades_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (315,'2025_09_29_194930_add_allow_faculty_cor_print_to_school_years',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (316,'2025_09_29_210800_ensure_grade12_sections',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (317,'2025_09_30_072335_add_allow_coordinator_cor_print_to_school_years',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (318,'2025_09_30_132500_remove_enrollment_subjects_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (319,'2025_10_01_033408_fix_class_details_table_structure',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (320,'2025_10_01_045859_fix_grades_status_column',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (321,'2025_10_01_140000_redesign_grades_table_for_philippine_shs',2);
