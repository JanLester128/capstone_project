...
export default function EnrollmentSettings({ 
    ...
    const [settings, setSettings] = useState({
        ...
        enrollment_start_date: currentSchoolYear?.enrollment_start_date || '',
        enrollment_end_date: currentSchoolYear?.enrollment_end_date || '',
    ...
    return (
        <>
            <Head title="Enrollment Settings" />
                ...
                <div className={`flex-1 transition-all duration-300 ${sidebarCollapsed ? 'ml-16' : 'ml-64'}`}>
                    ...
                    <div className="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
                        <div className="flex items-center justify-between">
                            <div>
                                <h1 className="text-2xl font-bold text-gray-900">Enrollment Settings</h1>
                                <p className="text-sm text-gray-600 mt-1">
                                    Manage enrollment periods and student access
                                </p>
                            </div>
                            <button
